...
BASE_RUN_NAME="llavanext-clip-vit-large-patch14-336-Llama-3.1-8B-Instruct-pretrain-lora_r256_alpha512-blip558k-pretrain-pma_mlp-blip558k"
...
FINE_RUN_NAME="${BASE_RUN_NAME}-replaced_llm-finetune-dpa${SUFFIX}-cambrian737k"
DATA_PATH=${WORK_DIR}/data/Cambrian-10M/jsons/Cambrian737k.json
image_folder=${WORK_DIR}/data/Cambrian-10M
