...
class Conversation:
    ...
    def copy(self):
        return Conversation(system=self.system, roles=self.roles, messages=[[x, y] for x, y in self.messages], offset=self.offset, sep_style=self.sep_style, sep=self.sep, sep2=self.sep2, version=self.version, tokenizer=self.tokenizer)
...
conv_llava_llama_3 = Conversation(
    ...
    tokenizer=safe_load_tokenizer("/inspire/hdd/global_user/qiuxipeng-24028/pywang/cktan/models/Llama-3.1-8B-Instruct"),
