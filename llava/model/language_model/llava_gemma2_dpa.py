...
from llava.model.llava_cmo_arch import LlavaDPAMetaForCausalLM


class LlavaGemma2DPAConfig(Gemma2Config):
    model_type = "llava_gemma2_cal"


class LlavaGemma2DPAModel(LlavaMetaModel, Gemma2Model):
    config_class = LlavaGemma2DPAConfig

    def __init__(self, config: Gemma2Config):
        super(LlavaGemma2DPAModel, self).__init__(config)


class LlavaGemma2DPAForCausalLM(Gemma2ForCausalLM, LlavaDPAMetaForCausalLM):
    config_class = LlavaGemma2DPAConfig

    def __init__(self, config):
        super(Gemma2ForCausalLM, self).__init__(config)
        self.model = LlavaGemma2DPAModel(config)
...
AutoConfig.register("llava_gemma2_cal", LlavaGemma2DPAConfig)
AutoModelForCausalLM.register(LlavaGemma2DPAConfig, LlavaGemma2DPAForCausalLM)
