...
class LlavaGemmaDPAConfig(GemmaConfig):
    model_type = "llava_gemma_cal"


class LlavaGemmaDPAModel(LlavaMetaModel, GemmaModel):
    config_class = LlavaGemmaDPAConfig

    def __init__(self, config: GemmaConfig):
        super(LlavaGemmaDPAModel, self).__init__(config)


class LlavaGemmaDPAForCausalLM(GemmaForCausalLM, LlavaDPAMetaForCausalLM):
    config_class = LlavaGemmaDPAConfig

    def __init__(self, config):
        super(GemmaForCausalLM, self).__init__(config)
        self.model = LlavaGemmaDPAModel(config)
...
AutoConfig.register("llava_gemma_cal", LlavaGemmaDPAConfig)
AutoModelForCausalLM.register(LlavaGemmaDPAConfig, LlavaGemmaDPAForCausalLM)
