...
class LlavaLlamaDPAModel(LlavaMetaModel, LlamaModel):
    config_class = LlavaConfig

    def __init__(self, config: LlamaConfig):
        super(LlavaLlamaDPAModel, self).__init__(config)


class LlavaLlamaDPAForCausalLM(LlamaForCausalLM, LlavaDPAMetaForCausalLM):
    config_class = LlavaConfig
    ...
    def __init__(self, config):
        ...
        config.model_type = "llava_llama_cal"
        # config.rope_scaling = None

        self.model = LlavaLlamaDPAModel(config)
...
AutoConfig.register("llava_llama_cal", LlavaConfig)
AutoModelForCausalLM.register(LlavaConfig, LlavaLlamaDPAForCausalLM)
