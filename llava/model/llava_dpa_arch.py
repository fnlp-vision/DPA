...
from llava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_PATCH
...
class LlavaDPAMetaForCausalLM(ABC):
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            for i in range(num_images + 1):
                ...
                if i < num_images:
                    ...
                    cur_new_labels.append(torch.full((cur_image_features.shape[0],), IMAGE_TOKEN_PATCH, device=cur_labels.device, dtype=cur_labels.dtype))
